...
from mewcode.context.circuit_breaker import CircuitBreaker
from mewcode.context.config import auto_trigger_threshold, manual_precheck_threshold
...
from mewcode.context.offloader import OffloadResult, offload_and_snip
from mewcode.context.summarizer import CompactError, CompactResult, execute_compact
from mewcode.provider import BaseProvider, ToolDefinition
...
class ContextManager:
    ...
    用法::
        ...
        mgr = ContextManager(
            ...
            session_dir=Path("/project/.mewcode/sessions/1700000000-abc123"),
            provider=provider,
    ...
    async def compact(
        ...
        from mewcode.context.recovery import build_recovery_sections
    ...
    async def emergency_compact_and_retry_check(
        ...
        # 重建对话历史
        from mewcode.context.recovery import build_recovery_sections
        from mewcode.context.summarizer import select_recent_messages
        from mewcode.provider import Message
        ...
        from mewcode.context.config import MANUAL_SAFETY_MARGIN
