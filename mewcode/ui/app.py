...
from mewcode.cmd import CommandRegistry, Parser, dispatch as cmd_dispatch
from mewcode.core.conversation import Conversation
from mewcode.prompt.modules import Module
from mewcode.ui.autocomplete import AutocompleteMenu
from mewcode.ui.chat_history import ChatHistory
from mewcode.ui.chat_input import ChatInput
from mewcode.ui.uictl_impl import UICtlImpl
...
class MewCodeApp(App):
    ...
    async def on_mount(self) -> None:
        ...
        if self._mcp_servers and self._tool_registry is not None:
            from mewcode.mcp.manager import MCPClientManager
    ...
    async def _cmd_resume(self) -> None:
        ...
        try:
            from mewcode.session.scanner import scan_sessions
            from mewcode.session.recovery import load_jsonl
            ...
            if result.time_gap_hours is not None and result.time_gap_hours > 4:
                ...
                from mewcode.provider import Message as PMsg
    ...
    async def _run_agent(
        ...
        try:
            ...
            if natural_stop and self._memory_manager is not None:
                ...
                from mewcode.memory.updater import MemoryUpdater
