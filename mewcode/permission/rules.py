...
from mewcode.permission.types import Rule
...
class RuleEngine:
    ...
    def __init__(self, project_root: str, user_home: str) -> None:
        ...
        self._local_path = project_dir / ".mewcode" / "permissions.local.yaml"
        self._project_path = project_dir / ".mewcode" / "permissions.yaml"
        self._user_path = user_dir / ".mewcode" / "permissions.yaml"
