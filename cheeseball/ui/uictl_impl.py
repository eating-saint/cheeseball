...
包装 CheeseballApp，代理所有方法到 app 的对应方法/属性。
Handler 只看到 UICtl 接口，不暴露 CheeseballApp 类型。
"""
...
class UICtlImpl(UICtl):
    """UICtl 的具体实现，持有 CheeseballApp 引用。"""

    def __init__(self, app: CheeseballApp) -> None:
        self._app = app
    ...
    def set_permission_mode(self, mode: str) -> None:
        ...
        Args:
            mode: "plan" 或 "default"。
        """
        from cheeseball.permission.modes import Mode
    ...
    def clear_conversation(self) -> None:
        ...
        session_dir = Path.cwd() / ".cheeseball" / "sessions" / new_id
